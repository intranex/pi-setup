...
## Software
### Raspbian
1)	Download the latest [https://www.raspberrypi.org/downloads/raspbian/](raspbian lite image) from raspberrypi.org
2)	Use [https://www.balena.io/etcher/](Etcher) to flash the .iso file to a SD card 
...
`http://[pi-ip-addr]:5984/_utils`\
in a web browser, using the ip address of your pi\
